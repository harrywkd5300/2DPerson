...
HRESULT	CTurtle::Initialize(void)
{
	m_tFrame = FRAME(0.f, 8.f, 8.f);

	m_tUnit.vSize = D3DXVECTOR3(130.f, 60.f, 0.f);
	lstrcpy(m_tUnit.wstrObjKey, L"Turtle");
...
bool CTurtle::Picking(const D3DXVECTOR3& vPos)
{
	//타일의 위치벡터
