		...
		if (SelectLeeSoonSin == FALSE)
		{
			...
			if (m_iWay == WAY_UP)
			{
				CObjMgr::GetInstance()->AddGameObject(
					CFactory<CThunder>::CreateGameObject(m_tUnit.vPos.x , m_tUnit.vPos.y - 100.f, 0.f),
					OBJ_TYPE_EFFECT);
			}
			...
			{
				CObjMgr::GetInstance()->AddGameObject(
					CFactory<CThunder>::CreateGameObject(m_tUnit.vPos.x + 100.f, m_tUnit.vPos.y, 0.f),
					OBJ_TYPE_EFFECT);
			}
			...
			{
				CObjMgr::GetInstance()->AddGameObject(
					CFactory<CThunder>::CreateGameObject(m_tUnit.vPos.x + 100.f, m_tUnit.vPos.y - 100.f, 0.f),
					OBJ_TYPE_EFFECT);
			}
...
bool CDragon::Picking(const D3DXVECTOR3& vPos)
{
	//타일의 위치벡터
