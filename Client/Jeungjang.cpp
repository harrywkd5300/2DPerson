...
HRESULT	CJeungjang::Initialize(void)
{
	m_tFrame = FRAME(0.f, 8.f, 8.f);

	//m_tUnit.vPos = D3DXVECTOR3(200.f, 200.f, 0.f);
	m_tUnit.vSize = D3DXVECTOR3(15.f, 60.f, 0.f);
	lstrcpy(m_tUnit.wstrObjKey, L"Jeungjang");
...
void CJeungjang::Release(void)
{
	safeDelete(AStar);
}

void CJeungjang::MyFrameCheck()
{
...
bool CJeungjang::Picking(const D3DXVECTOR3& vPos)
{
	//타일의 위치벡터
