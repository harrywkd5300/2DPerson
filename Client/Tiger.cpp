...
void CTiger::Release(void)
{
	safeDelete(AStar);
}

void CTiger::MyFrameCheck()
{
...
bool CTiger::Picking(const D3DXVECTOR3& vPos)
{
	//타일의 위치벡터
