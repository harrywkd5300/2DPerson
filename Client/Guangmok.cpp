...
HRESULT	CGuangmok::Initialize(void)
{
	m_tFrame = FRAME(0.f, 8.f, 8.f);

	//m_tUnit.vPos = D3DXVECTOR3(200.f, 200.f, 0.f);
	m_tUnit.vSize = D3DXVECTOR3(90.f, 70.f, 0.f);
	lstrcpy(m_tUnit.wstrObjKey, L"Guangmok");
...
void CGuangmok::Release(void)
{
	safeDelete(AStar);
}

void CGuangmok::MyFrameCheck()
{
...
bool CGuangmok::Picking(const D3DXVECTOR3& vPos)
{
	//타일의 위치벡터
