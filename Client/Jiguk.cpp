...
HRESULT	CJiguk::Initialize(void)
{
	m_tFrame = FRAME(0.f, 8.f, 8.f);

	//m_tUnit.vPos = D3DXVECTOR3(200.f, 200.f, 0.f);
	m_tUnit.vSize = D3DXVECTOR3(140.f, 60.f, 0.f);
	lstrcpy(m_tUnit.wstrObjKey, L"Jiguk");
...
void CJiguk::Release(void)
{
	safeDelete(AStar);
}

void CJiguk::MyFrameCheck()
{
...
bool CJiguk::Picking(const D3DXVECTOR3& vPos)
{
	//타일의 위치벡터
