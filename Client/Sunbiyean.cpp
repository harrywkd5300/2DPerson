...
HRESULT	CSunbiyean::Initialize(void)
{
	m_tFrame = FRAME(0.f, 8.f, 8.f);
	m_iSelectUnit = 0;
	m_tUnit.vSize = D3DXVECTOR3(87.f, 50.f, 0.f);
	lstrcpy(m_tUnit.wstrObjKey, L"SunbiYean");
...
void CSunbiyean::Release(void)
{
	safeDelete(AStar);
}

void CSunbiyean::MyFrameCheck()
{
...
bool CSunbiyean::Picking(const D3DXVECTOR3& vPos)
{
	//타일의 위치벡터
